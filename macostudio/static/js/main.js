$(document).ready(function () {
	...
	function initializeThirdSlider() {
		if ($('#slider__rating').length) {
			...
			thirdSlider.noUiSlider.on('update', function(values, handle) {
				var sliderValue = parseFloat(values[handle]); // Get the slider value as a float
				thirdValue.innerHTML = sliderValue; // Update the displayed value
				ratingInput.value = sliderValue; // Update the hidden input field value
			});
		} else {
			return false;
		}
